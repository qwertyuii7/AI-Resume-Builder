    ...
    return (
        <div className='space-y-4'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={generateSummary} disabled={isGenerating} className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-all disabled:opacity-50'>
            ...
            <div className='mt-6'>
                ...
                <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'>Tip: Keep it concise (3-4 sentences) and focus on your most relevant achievments and skills.</p>
            </div>
        </div>
    )
}
